...
int main (){
    ...
    float area1, pib1, densidade1, pibpercap1, superpoder1; //definindo em números mais precisos a quantidade do pib, área e população da cidade 1 
    ...
    float area2, pib2, densidade2, pibpercap2, superpoder2; //definindo em números mais precisos a quantidade do pib, área e população da cidade 1 
